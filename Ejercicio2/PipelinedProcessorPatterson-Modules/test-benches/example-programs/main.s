...
L2: SUB X2, X2, X1
    ...
    MOVZ X29, #0x1, LSL #48
    STUR X29, [X30, #24] // MEM 25: 0x1000000000000000

    // =============================== PRUEBAS DE DATA HAZARDS ===============================
    ...
    ADD X4, X1, X5
    ADD X1, X6, X7
    STUR X1, [X30, #32] // MEM 26: 0x60

    // RAW
    LDUR X2, [X30, #32]
    ADD X1, X2, X2
    STUR X1, [X30, #40] // MEM 27: 0xC0

    // WAR
    ADD X5, X1, X1
    LDUR X1, [X30, #40]
    STUR X5, [X30, #48] // MEM 28: 0x180

    // WAW
    LDUR X29, [X30, #40]
    LDUR X29, [X30, #48]
    STUR X29, [X30, #56] // MEM 29: 0x180
